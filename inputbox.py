# Pygame module found online to help with textbox inputs
# Originally by Timothy Downs, inputbox written for my map editor
...
def display_box(screen, message):
    ...
    pygame.draw.rect(screen, (0, 0, 0), ((screen.get_width() / 2) - 100,
